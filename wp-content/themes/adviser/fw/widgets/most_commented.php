 ...
 */
add_action( 'widgets_init', 'axiomthemes_widget_most_commented_load' );

/**
 * Register our widget.
 */
function axiomthemes_widget_most_commented_load() {
	register_widget('axiomthemes_widget_most_commented');
}

/**
 * Most popular and commented Widget class.
 */
class axiomthemes_widget_most_commented extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_most_commented', 'description' => __('The most commented blog posts (extended)', 'axiomthemes'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'axiomthemes_widget_most_commented');

		/* Create the widget. */
		parent::__construct( 'axiomthemes_widget_most_commented', __('Axiomthemes - Most Commented Posts', 'axiomthemes'), $widget_ops, $control_ops );
	}

 ...
 */
add_action( 'widgets_init', 'axiomthemes_widget_flickr_load' );

/**
 * Register our widget.
 */
function axiomthemes_widget_flickr_load() {
	register_widget( 'axiomthemes_widget_flickr' );
}

/**
 * flickr Widget class.
 */
class axiomthemes_widget_flickr extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_flickr', 'description' => __('Last flickr photos.', 'axiomthemes') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'axiomthemes_widget_flickr' );

		/* Create the widget. */
		parent::__construct( 'axiomthemes_widget_flickr', __('Axiomthemes - Flickr photos', 'axiomthemes'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => __('Last flickr photos', 'axiomthemes') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php _e('Flickr ID (idGettr):', 'axiomthemes'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_count' )); ?>"><?php _e('Number of photos:', 'axiomthemes'); ?></label>

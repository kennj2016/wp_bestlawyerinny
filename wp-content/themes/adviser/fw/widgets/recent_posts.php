 ...
 */
add_action( 'widgets_init', 'axiomthemes_widget_recent_posts_load' );

/**
 * Register our widget.
 */
function axiomthemes_widget_recent_posts_load() {
	register_widget('axiomthemes_widget_recent_posts');
}

/**
 * Recent posts Widget class.
 */
class axiomthemes_widget_recent_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_posts', 'description' => __('The recent blog posts (extended)', 'axiomthemes'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'axiomthemes_widget_recent_posts');

		/* Create the widget. */
		parent::__construct( 'axiomthemes_widget_recent_posts', __('Axiomthemes - Recent Posts', 'axiomthemes'), $widget_ops, $control_ops );

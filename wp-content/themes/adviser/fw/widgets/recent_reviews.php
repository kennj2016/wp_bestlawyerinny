 ...
 */
add_action( 'widgets_init', 'axiomthemes_widget_recent_reviews_load' );

/**
 * Register our widget.
 */
function axiomthemes_widget_recent_reviews_load() {
	register_widget('axiomthemes_widget_recent_reviews');
}

/**
 * recent_reviews Widget class.
 */
class axiomthemes_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'axiomthemes'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'axiomthemes_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'axiomthemes_widget_recent_reviews', __('Axiomthemes - Recent reviews', 'axiomthemes'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		$post_rating = 'reviews_avg'.(axiomthemes_get_theme_option('reviews_first')=='author' ? '' : '2');

...
if ( !function_exists( 'axiomthemes_exists_visual_composer' ) ) {
	function axiomthemes_exists_visual_composer() {
		return class_exists('Vc_Manager');
	}
}

// Check if Visual Composer in frontend editor mode
if ( !function_exists( 'axiomthemes_vc_is_frontend' ) ) {
	function axiomthemes_vc_is_frontend() {

...
if ( !function_exists( 'axiomthemes_template_test_theme_setup' ) ) {
	add_action( 'axiomthemes_action_before_init_theme', 'axiomthemes_template_test_theme_setup', 1 );
	function axiomthemes_template_test_theme_setup() {
		axiomthemes_add_template(array(
			...
			'need_isotope' => false,
			'need_columns' => true,
			'title'  => __('Test tile /3 columns/', 'axiomthemes'),
			'thumb_title'  => __('Test image', 'axiomthemes'),
			'w'		 => 350,
			'h'		 => 350
		));
	}
...
// Template output
if ( !function_exists( 'axiomthemes_template_test_output' ) ) {
	function axiomthemes_template_test_output($post_options, $post_data) {

	...
	class CPCFF_MAIN
	{
		...
		public function admin_pages()
		{
			...
			else
			{
				...
				{
					@wp_redirect('https://cff.dwbooster.com/download');exit;
				}
				else if (isset($_GET["page"]) && $_GET["page"] == 'cp_calculated_fields_form_sub2')
				{
					@wp_redirect('https://cff.dwbooster.com/documentation');exit;
				}
				else if (isset($_GET["page"]) && $_GET["page"] == 'cp_calculated_fields_form_sub4')
				{
					@wp_redirect('https://wordpress.org/support/plugin/calculated-fields-form#new-post');exit;
				}
				else
